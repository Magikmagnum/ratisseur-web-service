 ...
 */
final class Version20240114153914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formations (id INT AUTO_INCREMENT NOT NULL, label_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, debut_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', fin_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', en_cour TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modify_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4090213733B92F39 (label_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
